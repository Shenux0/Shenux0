...
<h1 align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&pause=1000&color=929292&center=true&vCenter=true&width=600&lines=Full-Stack+Developer;Interactive+Media+Undergarduate;Problem+Solver+and+Learner;Gaming+Enthusiast;" alt="Typing SVG" />
</h1>
...
- 🤝 **Looking to:** Collaborate on exciting projects and learn from the community
...
const currentlyLearning = {
    ...
    nextGoals: ["TypeScript", "Next.js", "GraphQL"]
};

const motivation = "Every expert was once a beginner. Every pro was once an amateur.";
```
...
*"The best way to debug code is to step away from it and play a game. Solutions often come when you're not actively looking for them."*
